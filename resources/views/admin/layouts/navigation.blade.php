<div style="display:flex;flex-direction:column;flex:1;overflow-y:auto;padding:0 8px">
    ...
    <a href="{{ route('admin.product.index') }}" class="nav-item"><svg width="17" height="17" fill="none" stroke="currentColor"
     ...
     <a href="{{ route('admin.product.variant') }}" class="nav-item"><svg width="17" height="17" fill="none" stroke="currentColor"
            stroke-width="2" viewBox="0 0 24 24">
            <path d="M4 6h16M4 12h16M4 18h16" />
            <path d="M10 6v12" />
        </svg><span class="nav-label">Product Variants</span></a>
