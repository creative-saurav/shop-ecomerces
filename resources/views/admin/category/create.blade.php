...
<div class="page-title px-6 py-6 border-b border-slate-200/80">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-main">Create Category</h1>
            <p class="text-sm text-slate-500">Add a new category for your ecommerce products.</p>
        </div>
...
<div class="p-6">
    ...
    <form action="{{ route('admin.category.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
        @csrf
