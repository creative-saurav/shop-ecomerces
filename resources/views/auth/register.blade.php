    ...
    <main class="flex w-full min-h-screen" x-data="{ view: 'login' }">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-24 bg-white relative">
            ...
            <div class="w-full max-w-md">
                ...
                <div>
                    <div class="mb-10">
                        <h1 class="text-3xl font-heading font-bold text-gray-900 mb-2">Create Account</h1>
                        <p class="text-gray-500">Enter your details to get started with Zipley.</p>
                    </div>
                    ...
                    <form class="space-y-5">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <i class="ph ph-user absolute left-4 top-4 text-gray-400 text-lg"></i>
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div class="relative" x-data="{ show: false }">
                                <input :type="show ? 'text' : 'password'"
                                    class="w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-xl pl-11 pr-12 py-3.5 focus:outline-none focus:border-brand-500 focus:bg-white focus:ring-4 focus:ring-brand-500/10 transition-all"
                        ...
                        <div class="flex items-start gap-3 mt-4">
                            ...
                            <label for="terms" class="text-sm text-gray-600 leading-relaxed">I agree to Zipley's <a
                                    href="terms.html" class="text-brand-600 font-medium hover:underline">Terms of
                                    Service</a> and <a href="privacy.html"
                                    class="text-brand-600 font-medium hover:underline">Privacy Policy</a>.</label>
                        </div>

                        <button type="button" @click="window.location.href='account.html'"
                            class="w-full bg-gray-900 hover:bg-black text-white font-bold py-3.5 rounded-xl transition shadow-lg mt-4">Create
                            Account</button>
                    </form>

                    <div class="relative flex items-center justify-center my-8">
                        <div class="border-t border-gray-200 w-full"></div>
                        <span class="bg-white px-4 text-xs font-bold text-gray-400 absolute">OR SIGN UP WITH</span>
                    </div>

                    <div class="flex gap-4 mb-8">
                        <button
                            class="flex-1 border border-gray-200 rounded-xl py-3 flex items-center justify-center gap-2 hover:bg-gray-50 hover:border-gray-300 transition text-sm font-bold text-gray-700 shadow-sm">
                    ...
                    <p class="text-center text-gray-600 mt-6">
                        Already have an account? <a href="#" @click.prevent="view = 'login'"
                            class="text-brand-600 font-bold hover:underline">Sign In</a>
                    </p>
                </div>

                <!-- Forgot Password View -->
                <div x-show="view === 'forgot'" x-transition.opacity style="display: none;">
                    <div class="mb-6">
                ...
                <div x-show="view === 'reset'" x-transition.opacity style="display: none;">
